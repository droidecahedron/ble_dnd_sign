...
// ZBUS_CHAN_DEFINE(dm_chan, struct dm_data, NULL, NULL, ZBUS_OBSERVERS(dm_listener), ZBUS_MSG_INIT(0)); may not need yet.
...
void display(void *p1, void *p2, void *p3)
{
    ...
    lv_label_set_text(title_label, "Status Sign");
